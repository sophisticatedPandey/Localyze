        ...
        <div className="flex flex-col justify-center items-center h-screen md:flex-row">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md w-96">
                ...
                <div className="mb-4">
                    ...
                    <input type="password" id="password" name="password" className="w-full px-3 py-2 border rounded" required />
                </div>
                <button type="submit" className="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-300 cursor-pointer">Login</button>
